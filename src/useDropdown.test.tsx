...
describe('Commands', () => {
  ...
  beforeEach(() => {
    result = renderHook(() => useDropdown({ onSelect, items, ResizeObserver })).result;
  });
  ...
  test('should set higlighted index', () => {
    const { result } = renderHook(() => useDropdown({ onSelect, items, ResizeObserver }));
    act(() => {
...
describe('reducer', () => {
  ...
  beforeEach(() => {
    ...
    result = renderHook(() => useDropdown({ onSelect, items, reducer, ResizeObserver })).result;
  ...
  test('should dispatch on input change', () => {
    render(<input {...inputProps} role="input" />);
